...
<section class="relative bg-gradient-to-r from-gray-500 to-blue-400 py-20">
    <div class="absolute inset-0">
        <img src="./assets/img/iotheronew.jpg" alt="Hero Image" class="w-full h-full object-cover" />
      ...
      <div class="relative  z-10">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-black md:text-5xl lg:text-4xl text-left ml-48">IOT Solutions</h1>
        <p class="mb-8  font-normal text-white-500 lg:text-5xl sm:px-16 xl:px-48 text-white">Devloops International <br>pioneers the  future of <br> connectivity</p>
...
<section class="bg-white dark:bg-gray-900">
    ...
    <g fill="none">
        ...
        <path stroke="#d25b8b" stroke-linecap="round" stroke-width="1.5" d="M22 11.798c0-2.632 0-3.949-.77-4.804a2.984 2.984 0 0 0-.224-.225C20.151 6 18.834 6 16.202 6h-.374c-1.153 0-1.73 0-2.268-.153a4 4 0 0 1-.848-.352C12.224 5.224 11.816 4.815 11 4l-.55-.55c-.274-.274-.41-.41-.554-.53a4 4 0 0 0-2.18-.903C7.53 2 7.336 2 6.95 2c-.883 0-1.324 0-1.692.07A4 4 0 0 0 2.07 5.257C2 5.626 2 6.068 2 6.95M21.991 16c-.036 2.48-.22 3.885-1.163 4.828C19.657 22 17.771 22 14 22h-4c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14v-3"/>
                ...
                <p class="text-gray-500 dark:text-gray-400 lg:text-xl">Advanced security protocols to protect data .</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
    ...
    <g fill="none" stroke="#d25b8b" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
        ...
        <path d="M20 12a8 8 0 1 1-5.3-7.533"/>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Predictive Maintenance</h3>
                <p class="text-gray-500 dark:text-gray-400 lg:text-xl">Proactive upkeep for equipment and systems.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
    ...
    <path fill="#e86d92" d="M4 2H2v26a2 2 0 0 0 2 2h8v-2H4Z"/>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Integration Capabilities</h3>
                <p class="text-gray-500 dark:text-gray-400 lg:text-xl">Seamlessly connect with existing systems.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
    ...
    <path fill="#e86d92" d="m1014.86 967l-47 48q-10 9-24 9t-24-9l-151-152q-60 34-128 34q-106 0-181-75t-75-181t75-181t181-75t181 75t75 181q0 68-34 127l152 152q10 10 10 23.5t-10 23.5m-373.5-518q-79.5 0-136 56t-56.5 135.5t56.5 136t136 56.5t135.5-56.5t56-136t-56-135.5t-135.5-56m63.5-122v-6q0-27 19-45.5t45-18.5h128q27 0 46 18.5t19 45.5v320h-1q0-115-72.5-203.5T704.86 327m-320 122V193q0-27 19-45.5t45-18.5h128q27 0 45.5 18.5t18.5 45.5v128q-77 0-144 34.5t-112 93.5m0 383q45 60 112 94.5t144 34.5h64q0 26-18.5 45t-45.5 19h-576q-26 0-45-19t-19-45.5t18.5-45t45.5-18.5V64q0-26 19-45t45-19h128q27 0 45.5 19t18.5 45v833h64z"/>
                ...
                <p class="text-gray-500 dark:text-gray-400 lg:text-xl">Clear data representation for understanding.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                <svg width="24" height="24" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fill="#d25b8b" d="M30 9h-7v2h3.59L19 18.59l-4.29-4.3a1 1 0 0 0-1.42 0L6 21.59L7.41 23L14 16.41l4.29 4.3a1 1 0 0 0 1.42 0l8.29-8.3V16h2Z"/>
                ...
                <p class="text-gray-500 dark:text-gray-400 lg:text-xl"> Real-time data insights for informed decision-making.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
    ...
    <rect width="12.48" height="25.477" x="17.808" y="18.023" fill="none" stroke="#d25b8b" stroke-linecap="round" stroke-linejoin="round" rx="2.361" ry="2.361"/>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Remote Monitoring</h3>
                <p class="text-gray-500 dark:text-gray-400 lg:text-xl">Allowing users to access and manage them from anywhere.</p>
            </div>
        </div>
    </div>
  </section>
...
<section class="bg-white dark:bg-gray-900">
    ...
    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Internet Of Things</h2>
    <p class="mb-3 py-4">Utilize Devloops's IoT development services in sensor programming, gateway integration, connection, IoT applications, IoT platform development, and analytics to drive hyperconnectivity in your organization. Use cutting-edge IoT technologies to increase efficiency, engage customers, and improve the strategy by gaining business information more quickly.</p>
    <a href="{{('/contact')}}">
...
<section class="bg-white dark:bg-gray-900">
    ...
    <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
        ...
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <svg class="animate-bounce mx-auto my-2 py-3" width="80" height="80" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <path fill="#d25b8b" d="M0 0h48v48H0z" mask="url(#ipTMarketAnalysis0)"/>
     ...
     <h3 class="mb-4 text-2xl font-semibold py-2">Iot analytics</h3>
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <div class="rounded-full bg-red-100 p-2 inline-block">
            <svg  class="animate-bounce mx-auto my-2 py-3" width="80" height="80" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fill="#d25b8b" d="M12 3a15.471 15.471 0 0 1 9.687 3.41l1.427-1.429A17.43 17.43 0 0 0 .96 4.964l1.427 1.429A15.328 15.328 0 0 1 12 3m0 10a4.5 4.5 0 1 0 4.5 4.5A4.5 4.5 0 0 0 12 13m0 7a2.5 2.5 0 1 1 2.5-2.5A2.5 2.5 0 0 1 12 20"/>
                ...
                <h3 class="mb-4 text-2xl font-semibold py-2">Iot Connectivity</h3>
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <div class="rounded-full bg-red-100   p-2 inline-block">
            <svg  class="animate-bounce mx-auto my-2 py-3" width="81" height="81" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" stroke="#d25b8b" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
        ...
        <path d="M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3m-7-4V8"/>
                ...
                <h3 class="mb-4 text-2xl font-semibold py-2">Iot Security</h3>
