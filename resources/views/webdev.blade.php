...
<section class="bg-white dark:bg-gray-900 py-20">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-10 lg:px-2">
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Web Development</h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Revolutionize Your Online Presence with Cutting-Edge Solutions</p>
