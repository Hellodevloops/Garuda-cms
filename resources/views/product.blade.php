...
<section class="relative bg-gradient-to-r from-gray-500 to-blue-400 py-20">
    <div class="absolute inset-0">
        <img src="./assets/img/producthero.jpg" alt="Hero Image" class="w-full h-full object-cover" />
      ...
      <div class="relative  z-10">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-black md:text-5xl lg:text-4xl text-left ml-48">Product For customers</h1>
        <p class="mb-8  font-normal text-white-500 lg:text-5xl sm:px-16 xl:px-48 text-white">Unlock Your Business with <br>Tailor-Made Product.</p>
...
<section class="bg-white dark:bg-gray-900">
    ...
    <h2 class="mb-4  tracking-tight font-extrabold text-gray-900 dark:text-white text-center lg:text-4xl">Features built for scale</h2>
    <p class="text-gray-500 sm:text-xl lg:text-2xl mb-7 dark:text-gray-400 text-center  lg:text-2xl">The quickest and easiest theme for every team
</p>
    </div>
