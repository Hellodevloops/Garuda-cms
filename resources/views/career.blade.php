...
<section class="bg-gray-50 dark:bg-gray-800 py-24">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
        <div class="max-w-screen-sm mx-auto text-center">
            <h2 class="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">Work with us</h2>
            <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Work hard with a motivated team to launch perfectly crafted products you'll love.</p>
            <a href="#" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">See Job Openings</a>
        </div>
    </div>
</section>
<!-- End block -->
...
<section class="bg-gray-50 dark:bg-gray-800 ">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
        <div class="max-w-screen-sm mx-auto text-center">
            <!-- <h2 class="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">Work with us</h2> -->
            <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Don't worry if you don't see any roles you want to apply for now. Register your interest to be notified of any roles that come along that meet your criteria.</p>
            <a href="#" class="text-white bg-primary-700 hover:bg-primary-800  focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Register Your Interest</a>
        </div>
    </div>
</section>
<!-- End block -->
