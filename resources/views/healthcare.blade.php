...
<section class="bg-white dark:bg-gray-900 py-20">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-10 lg:px-2">
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-pink-500 md:text-5xl lg:text-6xl dark:text-white">Revolutionize Your
<span class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-black md:text-5xl lg:text-6xl dark:text-white">Health  <br>Journey with</span></h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Our Healthcare Software.</p>
...
<!-- 2nd section -->
<section class="bg-gradient-to-br from-pink-500 via-pink-200 to-pink-100 bg-white dark:bg-gray-900">


    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
    <div class="max-w-screen-md mx-auto flex flex-col items-center justify-center text-2xl px-5 mb-6">
    <h2 class="mb-4  tracking-tight font-extrabold text-gray-900 dark:text-white text-center lg:text-4xl">Freedom to build what you need</h2>
    <p class="text-gray-500 sm:text-xl dark:text-gray-400 pb-4 lg:text-2xl">Storefront Flexibility</p>
</div>
        ...
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <img src="./assets/img/story1new.png" alt="Your Image" class="mx-auto my-2 w-40 h-30 animate-bounce ">

            </div> 
     <h3 class="mb-4 text-2xl font-semibold py-2">Customizable Modules</h3>
                <p class="font-dark text-gray-500 sm:text-lg dark:text-gray-400">Our healthcare product software provides a modular approach, allowing users to choose and configure specific modules based on their operational needs.</p>
            ...
            <!-- Pricing Card -->
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <div class="rounded-lg  p-2 inline-block">
            <img src="./assets/img/story2new.png" alt="Your Image" class="mx-auto my-2 w-40 h-30 animate-bounce ">

            </div> 
                <h3 class="mb-4 text-2xl font-semibold py-2">Administration
Hub</h3>
                <p class="font-dark text-gray-500 sm:text-lg dark:text-gray-400">Elevate your operational efficiency with our sophisticated Administration Hub. Seamlessly manage your product catalog, engage with customers, and streamline order processing.</p>
                <!-- <div class="flex items-baseline justify-center my-8">
            ...
            <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <div class="rounded-lg    p-2 inline-block">
            <img src="./assets/img/story3new.png" alt="Your Image" class="mx-auto my-2 w-40 h-30 animate-bounce ">

            </div> 
                <h3 class="mb-4 text-2xl font-semibold py-2">Integration Capabilities</h3>
                <p class="font-dark text-gray-500 sm:text-lg dark:text-gray-400">Integration capabilities refer to an organization's capacity to seamlessly incorporate various systems, applications, and data sources into a unified and cohesive infrastructure.</p>
                <!-- <div class="flex items-baseline justify-center my-8">
...
<section class="bg-white dark:bg-gray-900 mt-18">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pricing Plan</h2>
          <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Our Simple & Affordable Plan</p>
      </div>
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <!-- Pricing Card -->
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <div class="flex justify-center items-baseline my-8 rounded-lg bg-gray-400">
                  <span class="mr-2 text-5xl font-extrabold py-6">$79</span>
              ...
              <ul role="list" class="mb-8 space-y-4 text-left">
                  <li class="flex items-center space-x-3">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span>Appointment Scheduling and Management</span>
                  </li>
                  <li class="flex items-center space-x-3">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span>Telehealth and Remote Patient Monitoring</span>
                  </li>
                  <li class="flex items-center space-x-3">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span>Billing and Revenue Cycle Management</span>
                  </li>
                  <li class="flex items-center space-x-3">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span>Integration with Wearable Devices and IoT</span>
                  </li>
                  <li class="flex items-center space-x-3">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                  ...
                  <li class="flex items-center space-x-3">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                      <span>Mobile Applications for Patients and Providers</span>
                  </li>
              </ul>
              <a href="#" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Try Free For 30days</a>
          </div>
          <!-- Pricing Card -->
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <!-- <h3 class="mb-4 text-2xl font-semibold ">Starter</h3> -->
              <!-- <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> -->
              <div class="flex justify-center items-baseline my-8 rounded-lg bg-gray-400">
                  <span class="mr-2 text-5xl font-extrabold py-6">$89</span>
                  <span class="text-gray-700 dark:text-gray-400">/month</span>
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <!-- <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> -->
              <div class="flex justify-center items-baseline my-8 rounded-lg bg-gray-400">
                  <span class="mr-2 text-5xl font-extrabold py-6">$99</span>
                  <span class="text-gray-700 dark:text-gray-400">/month</span>
              </div>
              ...
              <a href="#" class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Try Free For 30 Days</a>
          </div>
      </div>
  </div>
</section>
    ...
    <!-- /accordion sec ids -->
    <div id="about" class="container content-space-1">
    <!-- Heading -->
    <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
        <span class="text-secondary lead">Our Features</span>
        <h2 class="text-primary" style="color: rgba(0, 31, 63, 0.7) !important;">Real-time Communication Tools.</h2>
    </div>
    <!-- End Heading -->

    <div class="flex flex-wrap items-lg-center">
        <div class="order-lg-2 mb-7 mb-lg-0 lg:w-5/12">
            <!-- Nav Scroller -->
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-lg nav-pills nav-pills-shadow flex-lg-column gap-lg-1 p-3" id="featuresTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" href="javascript:;" id="appointment-tab" data-target="#appointment" aria-controls="appointment" aria-selected="true" style="min-width: 20rem;">
                            <!-- Media -->
                            <div class="flex items-start">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-body text-wrap mb-0">With our user-friendly interface, patients can easily schedule appointments.</p>
                                </div>
                            </div>
                            <!-- End Media -->
                        </a>
                    ...
                    <!-- Additional tabs -->
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="javascript:;" id="patients-tab" data-target="#patients" aria-controls="patients" aria-selected="false" style="min-width: 20rem;">
                            <!-- Media -->
                            <div class="flex items-start">
                                <span class="svg-icon svg-icon-sm text-primary">
                                    <!-- Replace with the appropriate SVG icon or image -->
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <!-- Your SVG path here -->
                                    </svg>
                                </span>
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-body text-wrap mb-0">Our software provides a secure and convenient platform for patients to communicate with healthcare providers.</p>
                                </div>
                            </div>
                            <!-- End Media -->
                        </a>
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="javascript:;" id="billing-tab" data-target="#billing" aria-controls="billing" aria-selected="false" style="min-width: 20rem;">
                            <!-- Media -->
                            <div class="flex items-start">
                                <span class="svg-icon svg-icon-sm text-primary">
                                    <!-- Replace with the appropriate SVG icon or image -->
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-body text-wrap mb-0">Our advanced billing software is designed to simplify and streamline your financial processes.</p>
                                </div>
                            </div>
                            <!-- End Media -->
                        </a>
        ...
        <div class="order-lg-1 lg:w-7/12">
            <!-- Tab Content -->
            <div class="tab-content" id="featuresTabContent">
                <div class="tab-pane fade show active" id="appointment" role="tabpanel" aria-labelledby="appointment-tab">
                    ...
                    <figure class="device-browser">
                        <div class="device-browser-frame">
                            <img class="device-browser-img" src="./assets/img/Appointment.png" alt="Appointment Image">
                        </div>
                    </figure>
                    <!-- End Browser Device -->
                </div>
                ...
                <div class="tab-pane fade" id="patients" role="tabpanel" aria-labelledby="patients-tab">
                    ...
                    <figure class="device-browser">
                        <div class="device-browser-frame">
                            <!-- Replace with the image for the Patients tab -->
                            <img class="device-browser-img" src="./assets/img/Patients.png" alt="Patients Image">
                        </div>
                    </figure>
                    <!-- End Browser Device -->
                </div>
                <div class="tab-pane fade" id="billing" role="tabpanel" aria-labelledby="billing-tab">
                    ...
                    <figure class="device-browser">
                        <div class="device-browser-frame">
                            <!-- Replace with the image for the Billing tab -->
                            <img class="device-browser-img" src="./assets/img/Billing.png" alt="Billing Image">
                        </div>
                    </figure>
                    <!-- End Browser Device -->
                </div>
...
<script>
    document.getElementById('appointment-tab').addEventListener('click', function () {
        showImage('appointment');
    });
    ...
    function showImage(tabId) {
        // Hide all images
        document.querySelectorAll('.tab-content img').forEach(function (img) {
            img.style.display = 'none';
        });

        // Show the image for the clicked tab
        document.querySelector(`#${tabId} img`).style.display = 'block';
    }
</script>
...
<div id="drawer-contact" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-contact-label">
   ...
   <form class="mb-6">
      ...
      <button type="submit" class="text-white bg-primary-700 hover:bg-primary-800 w-full focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 block">Send message</button>
   </form>
